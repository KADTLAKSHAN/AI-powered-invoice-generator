...
const SignUp = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (nameError || emailError || passwordError || confirmPassword) {
      setFieldErrors({
        name: nameError,
        email: emailError,
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {fieldErrors.name && touched.name && (
              <p className="mt-1 text-red-600">{fieldErrors.name}</p>
            )}
          </div>
          ...
          >
            {isLoading ? (
              <>
                <Loader2 className="w-4 h-w mr-2 animate-spin" /> Creating
                account...
              </>
            ) : (
              <>
