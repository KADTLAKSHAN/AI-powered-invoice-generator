...
const parseInvoiceFromText = async (req, res) => {
  ...
  try {
    const prompt = `You are an expert at extracting AI. Analyze the following text and extract the relevant information to create an invoice.
...
const generateReminderEmail = async (req, res) => {
  ...
  try {
    ...
    const prompt = `
    You are a professional and polite accounting assistant. Write a friendly remnder email to a client about an overdue or upcoming invoice payment.
...
const getDashboardSummary = async (req, res) => {
  try {
    ...
    The insights should be encouraging and helpful. Do not just repeat the data. For example, if there is a high outstanding amount, suggest sending reminders. If revenue is high, be encouraiging.
